This protocol is of 3 wired SPI Protocol.
  Means the connection between Master and Slave is of 3 wires{Chip-Select(cs),Slave-Clock(sclk),Serial-Data-In-Out(sdio)}.
  Here,
